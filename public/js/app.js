...
function updateCart(vegetable) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('/update-cart', vegetable).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var vegetable = JSON.parse(btn.dataset.vegetable);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_node_own"] = self["webpackChunkpizza_node_own"] || [];
